export interface ArbswapNavbar {
  aboutUs: string
  createOffer: string
  wallet: string
  support: string
...
export interface NexBridgeNavbar {
  home: string
...
export interface JoxHome {
  introHeader: string
  introDescription: string
  getStarted: string
}

export interface ArbSwapHome {
  introHeader: string
  introDescription: string
  getStarted: string
  buySOL: string
...
export interface NexBridgeHome {
  description: string
  crossChain: string
}
...
export interface NexBridgeDashboard {
  compose: string
